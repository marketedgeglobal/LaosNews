...
def _is_laos_relevant_entry(entry: dict) -> bool:
    ...
    keywords = [
        "laos", "lao", "lao pdr", "lao people's democratic republic", "vientiane", "luang prabang",
        "pakse", "savannakhet", "champasak", "attapeu", "mekong", "bolikhamxay", "houaphanh",
        "xieng khouang", "lao government",
    ]
...
def filter_entries(
    ...
    for e in entries:
        ...
        if _is_global_feed_source(source_url) and not _is_laos_relevant_entry(e):
            _log_rejection(
                source_url,
                title_text,
...
def _build_docs_shell(run_at: str) -> str:
    return "\n".join([
        ...
        '<script src="{{ \'/docs/assets/app.js\' | relative_url }}"></script>',
        "",
    ])
